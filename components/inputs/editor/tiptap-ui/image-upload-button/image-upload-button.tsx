...
// --- Tiptap UI ---
import type { UseImageUploadConfig } from "@/components/inputs/editor/tiptap-ui/image-upload-button"
import {
  IMAGE_UPLOAD_SHORTCUT_KEY,
  useImageUpload,
} from "@/components/inputs/editor/tiptap-ui/image-upload-button"
  ...
  (
    ...
    return (
      <Button
        ...
        tooltip={text ? t(text.toLowerCase()) : ""}
        onClick={handleClick}
        {...buttonProps}
        ref={ref}
      >
        {children ?? (
          <>
            ...
            {text && <span className="tiptap-button-text">{text ? t(text.toLowerCase()) : ""}</span>}
