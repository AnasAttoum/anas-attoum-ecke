...
// --- Icons ---
import { BoldIcon } from "@/components/inputs/editor/tiptap-icons/bold-icon";
import { Code2Icon } from "@/components/inputs/editor/tiptap-icons/code2-icon";
import { ItalicIcon } from "@/components/inputs/editor/tiptap-icons/italic-icon";
import { StrikeIcon } from "@/components/inputs/editor/tiptap-icons/strike-icon";
import { SubscriptIcon } from "@/components/inputs/editor/tiptap-icons/subscript-icon";
import { SuperscriptIcon } from "@/components/inputs/editor/tiptap-icons/superscript-icon";
import { UnderlineIcon } from "@/components/inputs/editor/tiptap-icons/underline-icon";
